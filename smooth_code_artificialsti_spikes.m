function smooth_code_artificialsti_spikes(varargin)
...
%g_balance = 0.98;
dg_K = 0.003;
for g_balance = linspace(0.7,1.3,10)
for x_contrast = 0.1:0.1:1
    for y_contrast = 0.1:0.1:1
        qi_contrasts = [x_contrast; y_contrast];
        repeats = 1;
                                                        ...
                                                        for rate_ext_E = [0.85 ]; %
                                                            for  tau_c_EE = [8]
                                                                ...
                                                                for tau_c_I = [20]
                                                                    ...
                                                                    qix = (-hw:hw)*2*pi/(2*hw + 1); %spatial coordinate in (-pi,pi)
